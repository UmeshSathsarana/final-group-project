...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO hiking_bookings (full_name, email, whatsapp, address, id_number, date_of_adventure, participants, duration, national_park, price) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssisss", $fullName, $email, $whatsapp, $address, $idNumber, $dateOfAdventure, $participants, $duration, $nationalPark, $price);
    ...
    if ($stmt->execute()) {
        ...
        <body>
            <div class='message-container'>
                ...
                <a href='Hiking&CampingTours.html' class='btn btn-primary'>Go to Homepage</a>
            </div>
            <script>
                for (let i = 0; i < 100; i++) {
