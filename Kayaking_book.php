...
<body>
    <div class="booking-container">
        <h2 class="text-center">Kayaking</h2>
        <form action="kayaking_process_booking.php" method="post">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="kayaking" name="kayaking" required>
                    <option value="Place1">kalpitiya</option>
                    <option value="Place2">habarana</option>
                    <option value="Place3">Baddegama</option>
                    <option value="Place4">Bolagoda</option>
                    <option value="Place5">Hikkaduwa</option>
                </select>
            </div>
            <div class="form-group">
