...
<body>
    <div class="booking-container">
        <h2 class="text-center">Diving</h2>
        <form action="divingbooking.php" method="post">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="diving" name="diving" required>
            ...
            </div><div class="card-details mb-4">
